...
域名尽量选择短一点比较好记住，不要选择**中文域名**，比如 `张三.top` , 因为GitHub Pages **无法处理中文域名**，会导致你的域名无法使用。
...
如果你顺利搭建了自己的博客，请给不要害羞，我点个赞哦🙈

若中间遇到什么问题留言问我，我会尽力帮你们解决。

最后，给[我的Github仓库](https://github.com/qiubaiying/qiubaiying.github.io/) Star 一下吧！


# 补充

最近有人陆续给我私信，提出他们在建博客时遇到的问题，在此我总结一下常见的问题。

- 出现**404错误**
	
	出现**404错误**时，首先要检查仓库名，一定要是`github_name.github.io`的形式，`github_name`就是你在的GitHub注册的名字

![](https://ww4.sinaimg.cn/large/006tNbRwgy1fcmhr9k8poj31kw10in83.jpg)

- 修改`_config.yml`配置文件，博客没有变化

	刷新浏览器，若还是不行清除浏览器缓存，然后再刷新

	如果真的不行的话，需要去检查配置文件是否配置正确
	
	最后看你修改的`_config.yml`有没有提交保存😅
- 自定义域名
...
最后，遇到的什么问题可以私信我，我会尽力替大家解决的，情感问题就算了😀~
